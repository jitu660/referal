  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "highlight" && "bg-primary-500 text-white",
        variant === "outline" && "bg-surface border border-border",
        className
      )}
      {...props}
    />
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => <p ref={ref} className={cn("text-text-secondary text-sm", className)} {...props} />
);
